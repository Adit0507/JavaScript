...
// 1.
const events = [...new Set(gameEvents.values())]; //Unpack the set
console.log(events);
...
document.querySelector("button").addEventListener("click", function () {
  ...
  for (const [i, row] of rows.entries()) {        /* Here 'row' is the actual element while 'i' is the index*/
    const [first, second] = row
      .toLowerCase()
      .trim()
      .split("_"); /* trim() removes whitespaces*/
